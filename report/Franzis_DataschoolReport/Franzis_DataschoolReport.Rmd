...
I can see the potential in using R and Markdown for new work we have identified in my team and I am keen to further explore this.
I also want to apply my new skills to understand and use R projects, BitBucket repositories and Markdown documents colleagues have ceated under another project I am involved in. This will hopefully lead to my taking over some of the tasks previously done by my colleagues.  
